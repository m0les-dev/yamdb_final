...
from .permissions import (
    IsAdminOrReadOnly, IsAuthorOrModerPermission, OwnerOrAdmins,
)
...
class CategoryViewSet(ModelMixinSet):
    """
    Получаем список всех категорий. Права доступа: Доступно без токена
    """
...
class GenreViewSet(ModelMixinSet):
    """
    Получаем список всех жанров. Права доступа: Доступно без токена
    """
...
class TitleViewSet(ModelViewSet):
    """
    Получаем список всех объектов. Права доступа: Доступно без токена
    """
